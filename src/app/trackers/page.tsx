...
export default async function TrackersPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8 pb-12">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-zinc-100">Habit Tracker</h1>
        <p className="mt-2 text-gray-500 dark:text-zinc-400">Manage your daily habits, abstinence rules, and quantifiable goals.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <div className="rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 shadow-sm min-h-[500px]">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 shadow-sm">
            <h2 className="font-semibold text-gray-900 dark:text-zinc-100 mb-4">Why Track?</h2>
