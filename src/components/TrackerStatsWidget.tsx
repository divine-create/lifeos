  ...
  if (trackers.length === 0) {
    return (
      <div className="flex flex-col h-full items-center justify-center py-6 text-center">
        ...
        <p className="text-sm font-medium text-gray-700">No habits tracked yet</p>
        <Link href="/trackers" className="mt-2 text-xs font-medium text-blue-600 hover:underline">Go to Habit Tracker</Link>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full space-y-4">
      <div className="flex-1">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-gray-700">Today's Completion</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-3 flex items-center gap-3">
            <div className="p-2 bg-white rounded shadow-sm text-green-500"><CheckCircle2 className="h-4 w-4" /></div>
            <div>
              <p className="text-xs text-gray-500">Done Today</p>
              <p className="text-lg font-bold text-gray-900">{completedToday} <span className="text-xs font-normal text-gray-400">/ {totalHabits}</span></p>
            </div>
          </div>
          <div className="rounded-lg border border-gray-100 bg-gray-50 p-3 flex items-center gap-3">
            <div className="p-2 bg-white rounded shadow-sm text-orange-500"><TrendingUp className="h-4 w-4" /></div>
            <div>
              <p className="text-xs text-gray-500">Active Habits</p>
              <p className="text-lg font-bold text-gray-900">{totalHabits}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-4 border-t border-gray-100">
        <Link href="/trackers" className="w-full block text-center rounded-lg bg-white border border-gray-200 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition shadow-sm">
